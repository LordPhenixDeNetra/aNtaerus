...
Le code applicatif est structuré sous `antaerus/` :
...
- `antaerus/interfaces/web/` : interface utilisateur React/Vite
- `antaerus/interfaces/gateway_go/` : point d'entrée HTTP/WebSocket, auth, agrégation système
- `antaerus/providers/brain_python/` : orchestration LLM, mémoire et flux SSE internes
- `antaerus/providers/engine_rust/` : moteur Rust orienté performances et temps réel
- `antaerus/kernel/` : contrats, schémas et primitives transverses
- `antaerus/engine/` : bootstrap et orchestration transverse
...
```bash
cp antaerus/.env.example antaerus/.env
```

Sous Windows PowerShell :

```powershell
Copy-Item .\antaerus\.env.example .\antaerus\.env
```
...
```powershell
powershell -ExecutionPolicy Bypass -File .\antaerus\scripts\validation\smoke-text-chat.ps1
```
...
- [Workspace README](./antaerus/README.md)
- [Web UI](./antaerus/interfaces/web/README.md)
- [Brain Python](./antaerus/providers/brain_python/README.md)
- [Secrets et sécurité technique](./antaerus/docs/security/SECRETS.md)
...
- référez-vous aussi à [SECRETS.md](./antaerus/docs/security/SECRETS.md) pour les règles techniques déjà en place
